...
pages = [str(i) for i in range(0,64)]

filename = "future_oscillators.csv"
f = open(filename, "w", encoding="utf-8")
#with open(filename, "w", encoding="utf-8") as f:
#header = "manufacturer; description; qty_available; others\n"
header = "manufacturer_part; manufacturer; description; pricing; qty_available; package; oscillator_type; operating_frequency; Frequency_Stability; Supply_Voltage; Supply_Current; Symmetry; Load_Capacitance; Output_Type; Operating_Temp_Range; Duty_Cycle-Max; Rise_Time; Fall_Time; Dimension; No_Of_Terminals; Moisture_Sensitivity_Level; Mounting_Feature\n"

for page in pages:

    my_url = 'https://www.futureelectronics.com/c/electromechanical/timing-devices--oscillators/products?q=%3Arelevance&text=&pageSize=100&page=' + page
    ...
    for container in containers:
	    ...
	    f.write(manufacturer_part + ";" + manufacturer + ";" + description + ";" + pricing + ";" + availability + ";" + others + ";" + asc21 + ";" + asc22 + ";" + asc23 + ";" + asc24 + ";" + asc25 + ";" + asc26 + ";" + asc27 + ";" + asc28 + ";" + asc29 + ";" + asc210 + ";" + asc211 + ";" + asc212 + ";" + asc213 + ";" + asc214 + ";" + asc215 + ";" + asc216 + "\n")
