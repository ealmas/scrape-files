...
pages = [str(i) for i in range(0,99)]

filename = "future_inductors.csv"
...
for page in pages:
    ...
    my_url = 'https://www.futureelectronics.com/c/passives/inductors/products?q=%3Arelevance&text=&pageSize=100&page=' + page
