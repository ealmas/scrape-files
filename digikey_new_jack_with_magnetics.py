...
filename = "digikey_jack_with_magnetics.csv"
f = open(filename, "w")
header = "mfg_partnumber; unit_price; manufacturer; description; qty_available; min_qty; packaging; series; status; connector_typee; number_of_ports; number_of_rows; applications; mounting_type; orientation; termination; height_above_board; led_color; number_of_cores; shielding; features; tab_direction; contact_material; contact_finish; operating_temperature\n"

for page in pages:

    my_url = 'https://www.digikey.com/products/en/connectors-interconnects/modular-connectors-jacks-with-magnetics/365?FV=ffe0016d&quantity=0&ColumnSort=0&pageSize=500&page=' + page
    ...
    for container in containers:
	    ...
	    tlrnc = container.find_all("td",{"class":"CLS 405 ptable-param"})
	    try:
	    	applications = tlrnc[0].text.strip()
	    except IndexError:
	    	applications = 'null'
	    ...
	    rstnc = container.find_all("td",{"class":"CLS 759 ptable-param"})
	    try:
	    	height_above_board = rstnc[0].text.strip()
	    except IndexError:
	    	height_above_board = 'null'
	    ...
	    slf = container.find_all("td",{"class":"CLS 758 ptable-param"})
	    try:
	    	number_of_cores = slf[0].text.strip()
	    except IndexError:
	    ...
	    size = container.find_all("td",{"class":"CLS 252 ptable-param"})
	    try:
	    	operating_temperature = size[0].text.strip()
	    except IndexError:
	    ...
	    f.write(part_numbers + ";" + price + ";" + manufacturer + ";" + description + ";" + qty_available + ";" + min_qty + ";" + packaging + ";" + series + ";" + status + ";" + connector_typee + ";" +  number_of_ports + ";" + number_of_rows + ";" + applications + ";" + mounting_type + ";" + orientation + ";" + termination + ";" + height_above_board + ";" + led_color + ";" + number_of_cores + ";" + shielding + ";" + features + ";" + tab_direction + ";" + contact_material  + ";" + contact_finish + ";" + operating_temperature + "\n")
