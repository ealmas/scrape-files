...
filename = "future_resonators.csv"
f = open(filename, "w", encoding="utf-8")
#with open(filename, "w", encoding="utf-8") as f:
#header = "manufacturer; description; qty_available; others\n"
header = "manufacturer_part; manufacturer; description; pricing; qty_available; package; Operating_Frequency; Load_Capacitance; Frequency_Tolerance; Temperature_Stability; Supply_Voltage; Operating_Temp_Range; Aging; Storage_Temperature_Range; No_Of_Pins; Dimension; Moisture_Sensitivity_Level; Mounting_Feature\n"

for page in pages:

    my_url = 'https://www.futureelectronics.com/c/electromechanical/timing-devices--resonators/products?q=%3Arelevance&text=&pageSize=100&page=' + page
    ...
    for container in containers:
	    ...
	    f.write(manufacturer_part + ";" + manufacturer + ";" + description + ";" + pricing + ";" + availability + ";" + others + ";" + asc21 + ";" + asc22 + ";" + asc23 + ";" + asc24 + ";" + asc25 + ";" + asc26 + ";" + asc27 + ";" + asc28 + ";" + asc29 + ";" + asc210 + ";" + asc211 + ";" + asc212 + "\n")
