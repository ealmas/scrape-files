...
for page in pages:
    ...
    my_url = 'https://www.futureelectronics.com/c/semiconductors/wireless-rf--antennas/products?q=%3Arelevance&text=&pageSize=100&page=' + page
