...
pages = [str(i) for i in range(0,21)]

filename = "future_RJ45.csv"
...
for page in pages:
    ...
    my_url = 'https://www.futureelectronics.com/c/interconnect/connectors-data-telecom/products?q=%3Arelevance&text=&pageSize=100&page=' + page
