...
#filename = "master_abr_smd_oscillators.csv"
#f = open(filename, "w")
#header = "name; lead_time; price\n"
#f.write(header)

with open('master_abr_smd_oscillators.csv', 'w') as f:
	f.write("name; lead_time; price\n")

driver = webdriver.Chrome(executable_path =r"C:\Users\elif.issi\Desktop\chrome\chromedriver.exe")

for page in pages:

    urlpage = 'https://www.masterelectronics.com/products/oscillators-crystals/oscillators/smd-crystal-oscillators/?Manf=abracon&pagenum=' + page
    driver.get(urlpage)
    ...
    with open('master_abr_smd_oscillators.csv','a') as f:
