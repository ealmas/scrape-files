...
pages = [str(i) for i in range(0,3)]

filename = "future_RFID.csv"
f = open(filename, "w", encoding="utf-8")
#with open(filename, "w", encoding="utf-8") as f:
#header = "manufacturer; description; qty_available; others\n"
header = "manufacturer_part; manufacturer; description; pricing; qty_available; Lead_Time; Package; Package_Style; Type; Clock_Frequency-Max; Range; Supply_Current; Supply_Voltage; Gain; Sensitivity; Frequency_Range; Power_Dissipation; Operating_Temp_Range; Storage_Temperature_Range; No_Of_Terminals; Moisture_Sensitivity_Level; Dimension; Mounting_Feature\n"

for page in pages:

    my_url = 'https://www.futureelectronics.com/search/?q=rfid:relevance:category:rfid&selectedTab=products&text=rfid&pageSize=100&page=' + page
    ...
    for container in containers:
	    ...
	    f.write(manufacturer_part + ";" + manufacturer + ";" + description + ";" + pricing + ";" + availability + ";" + others + ";" + others2 + ";" + asc20 + ";" + asc21 + ";" + asc22 + ";" + asc23 + ";" + asc24 + ";" + asc25 + ";" + asc26 + ";" + asc27 + ";" + asc28 + ";" + asc29 + ";" + asc210 + ";" + asc211 + ";" + asc212 + ";" + asc213 + ";" + asc214 + ";" + asc215 + "\n")
