...
pages = [str(i) for i in range(0,17)]

filename = "future_transformers.csv"
...
for page in pages:
    ...
    my_url = 'https://www.futureelectronics.com/c/passives/transformers/products?q=%3Arelevance&text=&pageSize=100&page=' + page
